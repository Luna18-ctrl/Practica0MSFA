...
R,L,C = 10E3,220E-6,220E-6
num = [1]
den = [C*L,C*R,1]
sys = ctrl.tf(num,den)
print(f"funcion de transferencia del sistema: {sys}")
# Componentes del controlador
kP,kI,kD = 168.07174721143,2377.15416469961,0.386154983035383
Cr = 1E-6
Re = 1/(kI*Cr)
Rr = kP*Re
Ce = kD/Rr
...
print(f"el valor de la resistencia de Rr {Rr} ohms")
...
plt.plot(t,pidu1,':',linewidth = 4,color = clr6,label = 'Pao(t)')
...
plt.plot(t,pidu2,':',linewidth = 4,color = clr6,label = 'Pao(t)')
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(0,1.1); plt.yticks(np.arange(0,1.2,0.1))
plt.xlabel('t[s]',fontsize = 11)
plt.ylabel('Vi[s]',fontsize = 11)
...
plt.plot(t,pidu3,':',linewidth = 4,color = clr6,label = 'Pao(t)')
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(0,1.1); plt.yticks(np.arange(0,1.2,0.1))
plt.xlabel('t[s]',fontsize = 11)
plt.ylabel('Vi[s]',fontsize = 11)
...
plt.plot(t,pidu4,':',linewidth = 4,color = clr6,label = 'Pao(t)')
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
